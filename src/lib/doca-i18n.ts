...
const translations = {
  it: {
    ...
    heroBodyParts: [
      ...
      { text: "viaggio, contaminazione e quartiere", bold: true },
      { text: ". Dove magari ritrovate un ricordo… o ne create uno nuovo." },
    ],
    reserve: "Ordina ora",
    reserveHere: "Ordina qui",
    ...
    findBody: "Ci trovi in zona Corvetto, in Via Breno 2. Passa per il pane, fermati per un caffè o ordina dal menu.",
    address: "Indirizzo",
    contact: "Telefono",
    hours: "Orari",
    ...
    footerBodyParts: [
      ...
      { text: " fondata da " },
      { text: "Queren Girardi", bold: true },
      { text: " a Milano Corvetto. " },
      { text: "Pane, caffè filtro e dolci brasiliani", bold: true },
      { text: " sotto lo stesso tetto." },
    ],
    footerLocation: "Dove siamo",
    footerHours: "Orari",
    whatsappFooter: "Ordina dal menu ->",
  ...
  pt: {
    ...
    heroBodyParts: [
      ...
      { text: "viagem, mistura e vizinhança", bold: true },
      { text: ". Onde você pode reencontrar uma lembrança… ou criar uma nova." },
    ],
    reserve: "Peça agora",
    reserveHere: "Peça aqui",
    ...
    findTitleLead: "Via Breno 2,",
    findTitleAccent: "Milano Corvetto.",
    findBody: "Estamos na Via Breno 2, no bairro Corvetto. Passe para buscar pão, fique para um café ou peça pelo menu.",
    address: "Endereço",
    contact: "Telefone",
    hours: "Horários",
    ...
    footerBodyParts: [
      ...
      { text: " fundada por " },
      { text: "Queren Girardi", bold: true },
      { text: " em Milano Corvetto. " },
      { text: "Pão, café coado e doces brasileiros", bold: true },
      { text: " sob o mesmo teto." },
    ],
    footerLocation: "Onde estamos",
    footerHours: "Horários",
    whatsappFooter: "Peça pelo menu ->",
  ...
  en: {
    ...
    heroBodyParts: [
      ...
      { text: "travel, exchange and community", bold: true },
      { text: ". Somewhere to find an old memory, or make a new one." },
    ],
    reserve: "Order now",
    reserveHere: "Order here",
    ...
    findBody: "Find us at Via Breno 2 in Corvetto. Drop in for bread, stay for a coffee or order from the menu.",
    address: "Address",
    contact: "Phone",
    hours: "Hours",
    ...
    footerBodyParts: [
      ...
      { text: " founded by " },
      { text: "Queren Girardi", bold: true },
      { text: " in Milan's Corvetto district. " },
      { text: "Bread, filter coffee and Brazilian cakes", bold: true },
      { text: " under one roof." },
    ],
    footerLocation: "Find us",
    footerHours: "Hours",
    whatsappFooter: "Order from the menu ->",
