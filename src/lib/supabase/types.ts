...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      tables: {
        Row: { created_at: string; id: string; label: string; seats: number | null; tenant_id: string };
        Insert: { created_at?: string; id?: string; label: string; seats?: number | null; tenant_id: string };
        Update: { created_at?: string; id?: string; label?: string; seats?: number | null; tenant_id?: string };
        Relationships: [];
      };
      tenant_overrides: {
