...
import TavoloSummaryPage from "@/app/tavolo/[number]/page";

export default async function PreviewTavoloSummaryRoute({
  params,
}: {
  params: Promise<{ previewSlug: string; number: string }>;
}) {
